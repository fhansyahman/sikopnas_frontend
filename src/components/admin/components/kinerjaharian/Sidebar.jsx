...
import { 
  ...
  Map, ChevronDown, Shield, Settings, Bell, LogOut
} from "lucide-react";
  ...
  const sidebarMenu = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { name: "Status Kontrak", icon: <Shield size={14} />, href: "/admin/statuskontrak" },
    ...
    },
    {
      ...
      submenu: [
        { name: "Detail Presensi", icon: <Clock size={14} />, href: "/admin/presensihariini" },
        { name: "Atur Waktu Kerja", icon: <Settings size={14} />, href: "/admin/waktukerja" },
      ],
    },
    {
    ...
    }, 
    {
      ...
      href: "/admin/laporan",
      submenu: [
        { name: "Laporan Kehadiran", icon: <Clock size={14} />, href: "/admin/laporankehadiran" },
        { name: "Laporan Kinerja", icon: <ClipboardList size={14} />, href: "/admin/laporankinerja" },
      ],
    },
  ];
