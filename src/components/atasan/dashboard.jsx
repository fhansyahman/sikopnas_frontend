  ...
  const renderContent = () => {
    ...
    switch (activeTab) {
      ...
      case 'kinerja':
        return <KinerjaTab 
          {...kinerja}
          handleExportKinerjaChart={kinerja.handleExportKinerjaChart}
          handleExportWilayahChart={kinerja.handleExportWilayahChart}
          exportKinerjaPegawai={kinerja.exportKinerjaPegawai}
          exportStatistikWilayah={kinerja.exportStatistikWilayah}
          exportRekapKinerja={kinerja.exportRekapKinerja}
          exportAllData={kinerja.exportAllData}
        />;
      case 'monitoring':
